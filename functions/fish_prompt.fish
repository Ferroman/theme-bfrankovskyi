...
function _print_git_status -a main_color -a color_normal -a color_bracket -a color_unpushed -a color_dirty
  set -l git_branch_name (__git_branch_name)

  if [ $git_branch_name ]
    set -l git_pending_commits_count (__git_pending_commits_count $git_branch_name)
...
function fish_prompt
  ...
  set -l git_status (_print_git_status $color_git_branch $color_normal $color_bracket $color_unpushed $color_git_dirty)
